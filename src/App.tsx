...
export class App extends React.Component<Props, State> {
  ...
  render() {
    return (
      ...
      <h3 className="__quote">{this.state.quote?.quote}<span className="__author"> - ZEROPS, {this.state.quote?.createdAt ? format(this.state.quote?.createdAt ? new Date(this.state.quote?.createdAt) : new Date(this.state.quote?.created_at), 'MM/dd/yyyy') : ''}</span></h3>
